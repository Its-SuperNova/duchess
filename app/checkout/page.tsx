...
import { ArrowLeft, ChevronRight, Clock, Home, Ticket, FileText, AlertCircle } from "lucide-react"
...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen pb-40 md:pb-24" style={{ backgroundColor: "#F5F6FB" }}>
      {/* Header */}
      ...
      <div className="max-w-screen-md mx-auto pt-2">
        ...
        <div className="bg-white mx-4 p-4 rounded-2xl border border-gray-100 shadow-sm">
          <div className="flex items-start mb-6">
            ...
            <div>
              ...
              <button className="text-gray-500 underline">Want this later? Schedule it</button>
            </div>
          </div>
          ...
          <div className="flex items-start mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-500 break-words">2nd street, Barathipuram, Kannampalayam</p>
            </div>
        ...
        <div className="bg-white mx-4 my-4 p-4 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between">
              <span className="text-gray-600">GST and Taxes</span>
              <span>₹{gstAndTaxes.toFixed(2)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600 text-green-600">Discounts</span>
