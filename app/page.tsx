...
export default function Home() {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 299,
      isVeg: true,
      description: "Crisp choux pastry filled with rich chocolate cream and topped with chocolate glaze.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      price: 349,
      isVeg: true,
      description: "Buttery pastry shell filled with tangy lemon curd and dusted with powdered sugar.",
    },
    {
      id: 5,
      ...
      price: 399,
      isVeg: true,
      description: "Delicate almond meringue cookies filled with raspberry buttercream.",
    },
    {
      id: 6,
      ...
      price: 249,
      isVeg: true,
      description: "Classic cookies loaded with premium chocolate chips and baked to golden perfection.",
    },
    {
      id: 7,
      name: "Vanilla Cake",
      ...
      price: 449,
      isVeg: true,
      description: "Light and fluffy vanilla sponge cake with smooth buttercream frosting.",
    },
    {
      id: 8,
      ...
      price: 299,
      isVeg: true,
      description: "Rich, fudgy chocolate brownie with a crackly top and gooey center.",
    },
    {
      id: 9,
      ...
      price: 279,
      isVeg: true,
      description: "Moist vanilla cupcake topped with strawberry buttercream and fresh strawberry.",
    },
    {
      id: 10,
    ...
    },
    {
      ...
      price: 599,
      isVeg: true,
      description: "Rich chocolate cake with almond flour, topped with ganache and toasted almonds.",
    },
    {
      id: 12,
      ...
      price: 799,
      isVeg: true,
      description: "Festive layered cake with colorful sprinkles, perfect for special occasions.",
    },
  ]

  return (
    <div className="min-h-screen relative bg-white dark:bg-gray-900 flex flex-col">
      <Header />
      <Hero />
      ...
      <div className="mx-auto w-full">
        ...
        <div className="block lg:hidden px-4 md:px-6 py-6 md:py-8 mb-20">
          <h2 className="text-2xl font-bold mb-4 text-center">Why We Are Best?</h2>
          <img src="/why-we-are-best-mobile.png" alt="Why we are the best" className="w-full rounded-3xl shadow-md" />
        </div>
