          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center justify-center gap-4 mt-4 md:mt-0">
              <Image
                ...
                width={60}
                height={40}
                className="h-8 w-auto bg-white border border-gray-200 dark:border-none rounded-sm p-1"
              />
              ...
              <Image
                ...
                width={60}
                height={40}
                className="h-8 w-auto bg-white rounded-sm p-1 border border-gray-200 dark:border-none"
              />
              <Image
